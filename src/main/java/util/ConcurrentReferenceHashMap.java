// ConcurrentReferenceHashMap implementation copied from spring-framework.
// The only change that has been made is the package declaration and some references to spring-internal classes have been removed.
package util;
